...
import { Snowflake, Factory, Warehouse, Ship } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
          {facilityStats.map((stat) => {
            ...
            return (
              ...
              >
                {/* Icon */}
                <div className="w-12 h-12 rounded-full bg-[#072433] text-cyan-300 flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
